...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="events-grid">
        <article class="event-card">
            ...
            <p class="event-meta">May 03, 2026 • 3:30 PM • Central Seminar Hall</p>
        ...
        <article class="event-card">
            ...
            <p class="event-meta">May 12, 2026 • 5:00 PM • Virtual Session</p>
        ...
        <article class="event-card">
            ...
            <p class="event-meta">May 20, 2026 • 2:00 PM • Career Lab</p>
