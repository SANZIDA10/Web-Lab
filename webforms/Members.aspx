<%@ Page Title="Members | KCC Portfolio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Members.aspx.cs" Inherits="WebLab.WebForms.MembersPage" %>
        ...
        <asp:Repeater ID="MembersRepeater" runat="server">
            <ItemTemplate>
                <article class="member-card">
                    <div class="member-avatar"><%# Eval("Name").ToString()[0].ToString().ToUpper() %></div>
